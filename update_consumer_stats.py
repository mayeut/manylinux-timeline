...
def _build_wheel_support_map(packages: list[str]) -> dict[str, dict[str, date]]:
    ...
    removed_packages: Final[dict[str, date]] = {
        ...
        "bittensor-burn-monitor": date(2026, 6, 8),
        "blitz-vec": date(2025, 12, 21),
        "browser-act-cli-lite": date(2026, 4, 28),
        "browserbear": date(2026, 5, 31),
        "bykcli": date(2026, 6, 10),
        "caddy-bin-edge": date(2026, 1, 18),
        "cadunpack": date(2026, 5, 19),
        ...
        "clirk": date(2026, 4, 26),
        "clogsec": date(2025, 11, 12),
        "code-puppy-core": date(2026, 4, 18),
        "codepuppy-rs-core": date(2026, 4, 18),
        "codepuppy-rs-turbo-ops": date(2026, 4, 18),
        "codepuppy-rs-turbo-parse": date(2026, 4, 18),
        "codetool-find-files": date(2026, 5, 19),
        "codetool-search": date(2026, 5, 21),
        "codetool-search-text": date(2026, 5, 19),
        "colorinal": date(2025, 7, 27),
        "complexity-tokenizer": date(2026, 4, 6),
        "contextro": date(2026, 5, 11),
        "copilot-bin-edge": date(2026, 1, 18),
        "cryalg": date(2025, 9, 24),
        "csvdb-tool": date(2026, 2, 12),
        "cutters": date(2026, 2, 21),
        "dart-bridge": date(2026, 6, 9),
        ...
        "hermes-dashboard": date(2026, 4, 18),
        "hermes-identity-plugin": date(2026, 5, 29),
        "hikyuu-noarrow": date(2025, 12, 24),  # windows only
        "hivemind-p2p": date(2026, 1, 30),
        "hwcomponents-cacti": date(2026, 3, 12),
        "ids-rs": date(2026, 3, 18),
        "ids-tk": date(2026, 3, 18),
        ...
        "llm-input-harderning": date(2026, 4, 26),
        "logcrypt": date(2026, 3, 26),
        "lucit-licensing-python": date(2026, 4, 13),
        "lycan": date(2026, 5, 27),
        "manapy-domain": date(2026, 4, 17),
        "mary-elizabeth-utils": date(2026, 3, 18),
        "mchp-gpio-ctl": date(2025, 10, 14),
        "mdo-test-pypi": date(2026, 5, 20),
        "micro-language": date(2026, 5, 27),
        "minify-bin-edge": date(2026, 1, 18),
        "mlbi-scodia": date(2026, 2, 13),
        "mosec-tiinfer": date(2025, 9, 2),
        "mrapids": date(2025, 9, 4),
        "msgspec-arise": date(2026, 4, 9),
        "myrustlib": date(2026, 5, 8),
        ...
        "python-cxx": date(2026, 5, 4),
        "python-libtorrent-bin": date(2026, 5, 12),
        "qlip-algorithms": date(2025, 10, 15),
        "qlip-core": date(2025, 10, 15),
        "qlip-serve-generator": date(2025, 9, 9),
        "quasar-rs": date(2025, 12, 4),
        "rabo-robocap": date(2026, 5, 4),
        "rallyplot": date(2026, 4, 2),
        "rawler-py": date(2026, 5, 28),
        "rbdlp": date(2026, 2, 13),
        "rclone-bin-edge": date(2026, 1, 18),
        "repotoire": date(2026, 2, 10),
        "retracesoftware-functional": date(2026, 5, 6),
        "retracesoftware-functional-debug": date(2026, 5, 6),
        "retracesoftware-replay": date(2026, 5, 6),
        "retracesoftware-stream": date(2026, 5, 6),
        "retracesoftware-stream-debug": date(2026, 5, 6),
        "retracesoftware-utils": date(2026, 5, 6),
        "retracesoftware-utils-debug": date(2026, 5, 6),
        "ringdetect": date(2026, 4, 4),
        "riyadhai-blingfire": date(2026, 1, 15),
        "rlprof": date(2026, 4, 5),
        "robocap": date(2026, 3, 2),
        "rook-rs": date(2026, 5, 4),
        "rs-catch-22": date(2025, 11, 15),
        "run-on-business-day": date(2026, 4, 6),
        "rusta": date(2026, 5, 4),
        "rustmodels": date(2025, 11, 26),
        "rustivig": date(2025, 10, 8),
        "rustronomy": date(2026, 5, 7),
        "rusty-di-runner": date(2025, 12, 9),
        "rusty-graph": date(2026, 2, 11),
        "ruth-test": date(2026, 5, 30),
        "sagrada": date(2026, 3, 1),
        "scc-bin-edge": date(2026, 1, 18),
        "scodia": date(2026, 2, 13),
